...
function ProductDetail() {
  ...
  return (
    <section
      className={`${nunito.className} bg-warm-white min-h-screen py-10 px-5`}
    >
      ...
      <div className="flex flex-col gap-6 mt-6 md:flex-row items-center md:justify-around">
        ...
        <ul className="bg-cool-grey self-stretch text-night p-8 gap-4 lg:gap-12 rounded-md text-xl flex flex-col md:justify-center list-none">
          <li>
      ...
      <div className="text-center mt-20">
        <Button
          ...
          moreStyles="font-bold text-white px-20 py-4 hover:bg-bright-mustard rounded-xl bg-vibrant-teal text-xl active:scale-95 cursor-pointer tracking-wider"
        >
          Add to cart
        </Button>
      </div>
