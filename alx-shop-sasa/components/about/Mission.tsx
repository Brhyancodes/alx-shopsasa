  ...
  return (
    <section className={`${quicksand.className} bg-[#FAFAFA] py-10 px-4`}> {/* Warm White */}
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-4 md:mt-6 max-w-[924px] lg:mx-auto lg:gap-32">
        ...
        <div className="bg-[url(/images/vision.jpg)] bg-cover bg-center aspect-square rounded-full h-72 md:h-96 w-72 md:rounded-[53px] self-center inset-shadow-translucent"></div>
      </div>
    </section>
  );
}
