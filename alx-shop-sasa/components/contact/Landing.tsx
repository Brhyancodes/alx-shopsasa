...
function Landing() {
  return (
    <section
      className={`min-h-screen bg-[url(@/public/images/contact.jpg)] md:bg-[url(@/public/images/call.jpg)] bg-center bg-cover inset-shadow-overlay ${nunito.className} text-white flex pt-32`}
    >
