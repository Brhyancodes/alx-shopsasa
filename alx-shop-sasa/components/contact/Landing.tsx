...
function Landing() {
  return (
    <section
      className={`min-h-screen bg-[url(@/public/images/contact.jpg)] md:bg-[url(@/public/images/contact3.png)] bg-center bg-cover inset-shadow-overlay ${nunito.className} text-white flex pt-32`}
    >
